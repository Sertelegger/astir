...
export async function runTailer(/* rolloutPath, sessionId, relay */): Promise<void> {
  ...
  // Subagent rollouts discovered from their own tool hooks' transcript_path (REQ-007a).
}
/* c8 ignore stop */
